...
export default function PumpDetailClient({
  ...
  const nozzleStateMap = useMemo(() => {
    ...
    for (const item of pumpState.nozzles)
  ...
  const validateForm = () => {
    ...
    if (nozzleNumber === null || nozzleNumber <= 0)
      nextErrors.nozzleNumber =
        'Controller nozzle number must be greater than zero'
    if (displayNumber === null || displayNumber <= 0)
      nextErrors.displayNumber = 'Display number must be greater than zero'
    ...
    <div className="space-y-4">
      ...
      <Card>
        <CardContent className="grid gap-4 md:grid-cols-4">
          <div>
            ...
            <div className="text-sm font-semibold">{pump.code}</div>
          </div>
          <div>
          ...
          <div>
            ...
            <div className="text-sm font-semibold">{pump.pumpNumber}</div>
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardContent className="space-y-4">
          <PageHeader
            title="Nozzles"
            description="Assign a human-readable display number while retaining the controller nozzle/grade mapping."
            actions={
          ...
          {isLoading ? (
            ...
            <EmptyState
              ...
              description="Assign a tank and display number to a nozzle."
              action={
                <Button variant="primary" onClick={openCreate}>
                  Add nozzle
                </Button>
            ...
            <div className="overflow-hidden rounded-card border border-border bg-surface-card">
              <Table>
                <TableHeader>
                  <TableRow>
                    <TableHead>Display no.</TableHead>
                    <TableHead>Controller grade</TableHead>
                      ...
                      <TableRow key={nozzle.id}>
                        ...
                        <TableCell className="text-right">
                          <div className="flex items-center justify-end gap-2">
                            ...
                            <Button
                              variant="destructive"
                              onClick={() => void deleteNozzle(nozzle)}
                              disabled={isSaving}
                            >
                              Delete
                            </Button>
          ...
          <div className="mt-4 space-y-4">
            <div className="space-y-1">
              ...
              <p className="text-xs text-[var(--text-muted)]">
                This is the nozzle number shown to tenants and operators.
              </p>
            ...
            <div className="space-y-1">
              <label className="text-sm font-medium">
                Controller nozzle / grade number
              </label>
              <Input
                placeholder="DOMS grade/nozzle number"
                type="number"
                min={1}
              ...
              />
              <p className="text-xs text-[var(--text-muted)]">
                Used for forecourt/controller transaction matching; changing it
                can affect DOMS mapping.
              </p>
