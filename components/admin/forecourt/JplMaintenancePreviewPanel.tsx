...
export function JplMaintenancePreviewPanel() {
  ...
  return (
    <CollapsibleStatusSection
      title="DOMS maintenance command previews"
      status={activeSession ? 'approved session' : 'no approved session'}
      statusVariant={
      ...
      <Card>
        <CardContent className="space-y-4 p-4">
          <div className="flex flex-wrap items-start justify-between gap-3">
            <div>
              ...
              <p className="text-sm text-[var(--text-secondary)]">
                Build and validate future maintenance command envelopes behind
                an approved maintenance session. This panel does not send any
                DOMS/PSS command.
              </p>
            </div>
          ...
          <div className="rounded border border-amber-500/30 bg-amber-500/5 p-3 text-sm text-amber-800">
            Preview envelopes are planning artifacts only. They are not
            executable in this pass and must be compared against PSS
            Configurator, physical wiring, and site procedures before any future
            implementation enables writes.
          </div>
            ...
            <div className="grid grid-cols-1 gap-3 lg:grid-cols-2">
              <div className="space-y-2 text-sm text-[var(--text-secondary)]">
                ...
                <label className="flex items-start gap-2">
                  ...
                  />
                  <span>
                    Include install_Fp preview envelopes from FTC
                    pump/nozzle/tank mappings.
                  </span>
                </label>
                <label className="flex items-start gap-2">
                  <input
                    ...
                    onChange={(event) =>
                      setConfirmApproved(event.target.checked)
                    }
                    className="mt-1"
                  />
                  <span>
                ...
                <label className="flex items-start gap-2">
                  ...
                  />
                  <span>
                    I understand this is preview-only planning output.
                  </span>
                </label>
                <label className="flex items-start gap-2">
                  <input
