import { createProductCategoryService } from '@/src/modules/products/application/services/product-category-service'
...
export async function createProductCategory(params: {
  ...
  return await createProductCategoryService(params)
}
